...
class GameSprite(pygame.sprite.Sprite):
    def __init__(self, image_name, WZ=0, speed=1):
        ...
        # 定义图像属性
        self.image = image_name  # self.image 加载图像
        self.rect = self.image.get_rect()  # 和图像大小一致 必须位于image下方
        self.speed = speed
        self.WZ = WZ
...
class Background(GameSprite):
    ...
    def __init__(self):
        super(Background, self).__init__(pygame.image.load("./植物大战僵尸素材/地图(2).jpg"))
...
class Enemy(GameSprite):
    def __init__(self):
        ...
        super(Enemy, self).__init__(pygame.image.load("./植物大战僵尸素材/鬼蜡烛.gif"))
